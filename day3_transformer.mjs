...
function usage() { // defines a help message for a Command Line Interface (CLI) tool named day3_transformer.mjs
  return `
Usage:
  node day3_transformer.mjs --input data.json --out out.json [--team Alpha] [--minScore 900]

Options:
  --input     Path to input JSON (required) (now takes -i)
  --out       Path to output JSON (default: ./out.json) (takes -o)
